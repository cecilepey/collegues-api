...
public class CollegueServiceTest {
	...
	public void testNom2Caracteres() {
		...
		collegue = colService.ajouterUnCollegue(collegue); 
		
	}
	
	@Test (expected = CollegueInvalideException.class)
	public void testPrenom2Caracteres() {
